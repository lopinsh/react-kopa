...
export default async function MyGroupsPage({
        ...
        include: {
            group: {
                include: {
                    category: {
                        include: {
                            parent: { include: { parent: true, titles: { where: { lang: locale === 'en' ? 'en' : 'lv' } } } },
                            titles: { where: { lang: locale === 'en' ? 'en' : 'lv' } }
                        }
                    },
    ...
    const formattedGroups = userGroups.map(m => {
        // Find highest ancestor slug (usually L1)
        ...
        return {
            ...
            accentColor: m.group.category.parent?.color || m.group.category.color || '#F97316'
        };
    });
